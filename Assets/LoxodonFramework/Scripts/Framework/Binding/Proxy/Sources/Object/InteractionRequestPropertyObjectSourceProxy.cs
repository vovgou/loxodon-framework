...
{
    public class InteractionRequestPropertyObjectSourceProxy : AbstractPropertyObjectSourceProxy
    {
        private static readonly ILog log = LogManager.GetLogger(typeof(InteractionRequestPropertyObjectSourceProxy));
        ...
        public InteractionRequestPropertyObjectSourceProxy(object source, PropertyInfo propertyInfo) : base(source, propertyInfo)
        {
            this.BindEvent();
        }
        ...
        protected virtual void BindEvent()
        {
            ...
            this.request = (IInteractionRequest)proxyProperty.GetValue(this.Source);
            if (this.request == null)
                return;
